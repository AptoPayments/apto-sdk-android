...
class OkHttpClientProviderImpl : OkHttpClientProvider {
    ...
    override fun provide(): OkHttpClient {
        ...
        addInterceptors(okHttpClientBuilder, ApiKeyProvider.apiKey)
    ...
    private fun addInterceptors(okHttpClientBuilder: OkHttpClient.Builder, apiKey: String) {
        addLoggingInterceptor(okHttpClientBuilder)
        addApiKeyInterceptor(okHttpClientBuilder, apiKey)
    }
    ...
    private fun addApiKeyInterceptor(okHttpClientBuilder: OkHttpClient.Builder, apiKey: String) {
