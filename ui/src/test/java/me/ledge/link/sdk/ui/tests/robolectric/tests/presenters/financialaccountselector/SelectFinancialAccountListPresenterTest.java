package me.ledge.link.sdk.ui.tests.robolectric.tests.presenters.financialaccountselector;
...
public class SelectFinancialAccountListPresenterTest {
    ...
    public void selectedFinancialAccountIsCorrectlyPassed() {
        ...
        Assert.assertEquals("Selected account should be passed.", mModule.getFinancialAccount(), account);
    }
}
