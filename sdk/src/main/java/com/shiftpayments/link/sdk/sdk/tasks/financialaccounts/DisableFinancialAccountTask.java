...
public class DisableFinancialAccountTask extends ShiftApiTask<Void,Void,DisableFinancialAccountResponseVo,String> {
    /**
     ...
     */
    public DisableFinancialAccountTask(String accountId, ShiftApiWrapper apiWrapper,
    ...
    /** {@inheritDoc} */
    @Override
    protected DisableFinancialAccountResponseVo callApi() throws ApiException {
        return getApiWrapper().disableFinancialAccount(getRequestData());
    }
}
