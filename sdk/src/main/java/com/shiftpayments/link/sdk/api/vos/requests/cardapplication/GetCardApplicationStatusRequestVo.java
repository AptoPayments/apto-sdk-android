...
public class GetCardApplicationStatusRequestVo extends UnauthorizedRequestVo {

    @SerializedName("card_product_id")
    String cardProductId;

    public GetCardApplicationStatusRequestVo(String cardProductId) {
        this.cardProductId = cardProductId;
    }

    @Override
    public ShiftApiTask getApiTask(ShiftApiWrapper shiftApiWrapper, ApiResponseHandler responseHandler) {
        return new GetCardApplicationStatusTask(cardProductId, shiftApiWrapper, responseHandler);
    }
}
