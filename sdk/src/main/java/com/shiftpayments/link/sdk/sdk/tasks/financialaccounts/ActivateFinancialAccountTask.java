...
public class ActivateFinancialAccountTask extends ShiftApiTask<Void,Void,ActivateFinancialAccountResponseVo,String> {
    /**
     ...
     */
    public ActivateFinancialAccountTask(String accountId, ShiftApiWrapper apiWrapper,
