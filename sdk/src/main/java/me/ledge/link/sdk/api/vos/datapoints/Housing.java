...
public class Housing extends DataPointVo {
    public me.ledge.link.sdk.api.vos.IdDescriptionPairDisplayVo housingType;
    ...
    public Housing(int housingType, boolean verified, boolean notSpecified) {
        ...
        this.housingType = new me.ledge.link.sdk.api.vos.IdDescriptionPairDisplayVo(housingType, null);
    }
