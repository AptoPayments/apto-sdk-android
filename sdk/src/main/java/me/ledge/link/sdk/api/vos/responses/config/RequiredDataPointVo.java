package me.ledge.link.sdk.api.vos.responses.config;
...
public class RequiredDataPointVo {
    ...
    public me.ledge.link.sdk.api.vos.datapoints.DataPointVo.DataPointType type;
    ...
    public RequiredDataPointVo(me.ledge.link.sdk.api.vos.datapoints.DataPointVo.DataPointType type) {
        this.type = type;
        this.verificationRequired = false;
        this.notSpecifiedAllowed = false;
    }

    public RequiredDataPointVo(me.ledge.link.sdk.api.vos.datapoints.DataPointVo.DataPointType type, Boolean verificationRequired,
